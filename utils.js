...
a.utils.word2address = function word2address( string )
{
...
a.utils.str2hex = function str2hex( string )
{
...
a.utils.polygon = new Array();
a.utils.polygon.api = "https://api.polygonscan.com/api"
a.utils.polygon.apikey = "P2VD4Q197F12TVGTQT8982EAQI254DNJ4Z"

a.utils.searchIterate = function(address,blockNumber,api,apikey) { 
...
a.utils.procTx = function procTx(x) {
...
a.utils.searchInternal = function(term,api,apikey) { 
